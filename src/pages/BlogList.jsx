...
export default function BlogList() {
  return (
    <div className="bg-brand-periwinkle/10 min-h-[calc(100vh-80px)] py-16 sm:py-20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-brand-violet tracking-tight mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {posts.map((post) => (
            <article
              key={post.id}
              className="bg-white rounded-2xl p-6 sm:p-8 shadow-subtle hover:shadow-premium transition-all duration-300 border border-slate-100 flex flex-col justify-between group"
            >
              <div>
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-brand-violet group-hover:text-brand-violet/85 transition-colors mb-3 leading-snug">
              ...
              <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                <Link
                  to={`/blog/${post.slug}`}
                  className="text-sm font-bold text-brand-violet hover:text-brand-gold transition-colors inline-flex items-center gap-1.5 group/link"
                >
